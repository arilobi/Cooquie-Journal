...
3. Run the command, `npm install` in your VS Code terminal.
4. Run the final command to start the frontend with `npm run dev` 

## Live Server
Click the link on the description to the right hat will take you to the web application => 

## License
This project is licensed under the MIT License.

## Contacts
Feel free to contact me if you have any enquiries or suggestions at:
::marionnabulobi@gmail.com
